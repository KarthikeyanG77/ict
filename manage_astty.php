...
if (isset($_GET['action']) && $_GET['action'] == 'delete' && isset($_GET['id'])) {
    if ($is_admin) {
        try {
            ...
            $_SESSION['error'] = "Error deleting asset type: " . $e->getMessage();
            header("Location: manage_astty.php");
            exit();
        }
    } else {
...
$assetTypes = [];
$query = "SELECT * FROM asset_type ORDER BY type_name ASC";
$result = $conn->query($query);
if ($result) {
    $assetTypes = $result->fetch_all(MYSQLI_ASSOC);
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Asset Type Management - ICT IT Asset Management System</title>
    ...
    <div class="container">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Asset Type Management</h5>
                <?php if ($is_admin): ?>
                    <a href="add_astty.php" class="btn btn-primary btn-sm">
                        <i class="fas fa-plus"></i> Add New Asset Type
                    </a>
                <?php endif; ?>
            </div>
            <div class="card-body">
                            ...
                            <?php foreach ($assetTypes as $type): ?>
                                <tr>
                                    ...
                                    <td class="action-btns">
                                        <?php if ($is_admin): ?>
                                            <a href="edit_astty.php?id=<?php echo $type['type_id']; ?>" class="btn btn-warning btn-sm" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="manage_astty.php?action=delete&id=<?php echo $type['type_id']; ?>" 
