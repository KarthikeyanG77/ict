...
// Fetch all locations with category names
$query = "
...
<head>
    ...
    <title>Location Management - ICT IT Asset Management System</title>
    ...
    <div class="container">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <?php if ($is_admin): ?>
                    <a href="add_loc.php" class="btn btn-primary btn-sm">
            ...
            <?php if (isset($_SESSION['message'])): ?>
                <div class="alert alert-success m-3"><?= htmlspecialchars($_SESSION['message']) ?></div>
                        ...
                        <tbody>
                            <?php foreach ($locations as $location): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($location['category_name'] ?? 'Uncategorized'); ?></td>
                                    <td class="action-btns">
                                        <?php if ($is_admin): ?>
                                            <a href="edit_loc.php?id=<?php echo $location['location_id']; ?>" class="btn btn-warning btn-sm" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="del_loc.php?id=<?php echo $location['location_id']; ?>" 
