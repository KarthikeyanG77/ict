...
$location_id = $location_name = $category_id = "";
$error = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($error)) {
        $sql = "UPDATE location SET location_name = ?, category_id = ? WHERE location_id = ?";
        
        if ($stmt = $conn->prepare($sql)) {
            $stmt->bind_param("sii", $param_location_name, $param_category_id, $param_id);
...
<head>
    ...
    <title>Edit Location - ICT IT Asset Management System</title>
